...
//	public static Logger logger = LoggerFactory.getLogger(StringUtil.class);
	...
	private static final Pattern MAIL_PATTERN =
			Pattern.compile("^[A-Za-z0-9]+([-_.][A-Za-z0-9]+)*@([A-Za-z0-9]+[-.])+[A-Za-z0-9]{2,}$");
	 ...
	 * @return int参数
	 */
	public static int convertInt(String str, Integer defaults)
	{
		if (str == null)
		{
			return defaults;
     ...
     * @return
     */
    public static  List<Long> splitLongList(String string,String seperator){
        if(StringUtil.isEmpty(string)){
            return null;
        }
        ...
        for (int i = 0; i<length; i++)
        {
                Long result=convertLong(ss[i],null);
            if(result != null) {
                list.add(result);
            }
        }
     ...
     * @return
     */
    public static  List<Integer> splitIntegerList(String string,String seperator){
        if(StringUtil.isEmpty(string)){
            return null;
        }
        ...
        for (int i = 0; i<length; i++)
        {
            Integer result=convertInteger(ss[i],null);
            if(result != null) {
                list.add(result);
            }
        }
     ...
     * @return int参数
     */
    public static Integer convertInteger(String str, Integer defaults)
    {
        if (str == null)
        {
            return defaults;
    ...
    public static String getTicker(String ticker) {
        if(StringUtil.isEmpty(ticker)) return null;
    ...
    public static boolean isEnglishOrNumericOrUnderlineOrTransverseLine(String str) {
        Matcher m=Pattern.compile("^[A-Za-z0-9\\-\\_]*$").matcher(str);
        if (m.find()) {
            return true;
        }
        return false;
    ...
    public static boolean isEnglishOrNumeric(String str) {
    ...
    public static Integer retInteger(Object obj) {
        return obj != null ? Integer.valueOf(obj.toString().trim()) : null;
    }
    public static Long retLong(Object obj) {
        return obj != null ? Long.valueOf(obj.toString().trim()) : null;
    }
	...
	public static boolean checkMobile(String mobile) {
		...
		if (!mobile.startsWith("1") || (mobile.trim().length() != 11)) {
	...
	public static boolean checkEmail(String email) {
		...
		if (!MAIL_PATTERN.matcher(email).matches()) return false;
